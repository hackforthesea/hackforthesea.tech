...
c.MyOAuthenticator.oauth_callback_url = settings.SITE_URL + '/hub/oauth_callback'
c.MyOAuthenticator.client_id = settings.JUPYTERHUB_OAUTH_CLIENT_ID
c.MyOAuthenticator.client_secret = settings.JUPYTERHUB_OAUTH_CLIENT_SECRET
